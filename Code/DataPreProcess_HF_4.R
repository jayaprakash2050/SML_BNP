...
x_woutNA.scaled <- zscore(x_woutNA);

sto.scaled.theta <- 0;

sto.scaled.theta <- sto.gradient.descent(x=x_woutNA.scaled, y=y, num.iterations=50000, output.path=TRUE);

svm.model <- svm(target~., data = data);

scaled.theta <- gradient.descent(x=x_woutNA.scaled, y=y, num.iterations=100000, output.path=TRUE);


unscaled.theta <- gradient.descent(x=x_woutNA, y=y, num.iterations=1000, output.path=TRUE);


qplot(1:(nrow(unscaled.theta)), unscaled.theta[,1], geom=c("line"), xlab="iteration", ylab="theta_1")
qplot(1:(nrow(unscaled.theta)), unscaled.theta[,2], geom=c("line"), xlab="iteration", ylab="theta_2")
...
qplot(1:(nrow(scaled.theta)), scaled.theta[,3], geom=c("line"), xlab="iteration", ylab="theta_3")
qplot(1:(nrow(scaled.theta)), scaled.theta[,4], geom=c("line"), xlab="iteration", ylab="theta_4")
qplot(1:(nrow(scaled.theta)), scaled.theta[,5], geom=c("line"), xlab="iteration", ylab="theta_5")


qplot(1:(nrow(sto.scaled.theta)), sto.scaled.theta[,1], geom=c("line"), xlab="iteration", ylab="theta_1")
qplot(1:(nrow(sto.scaled.theta)), sto.scaled.theta[,2], geom=c("line"), xlab="iteration", ylab="theta_2")
qplot(1:(nrow(sto.scaled.theta)), sto.scaled.theta[,3], geom=c("line"), xlab="iteration", ylab="theta_3")
qplot(1:(nrow(sto.scaled.theta)), sto.scaled.theta[,4], geom=c("line"), xlab="iteration", ylab="theta_4")
qplot(1:(nrow(sto.scaled.theta)), sto.scaled.theta[,78], geom=c("line"), xlab="iteration", ylab="theta_78")

sto.scaled.theta.final <- sto.scaled.theta[nrow(sto.scaled.theta),];

write.csv(scaled.theta,file="scaled_numiter100k_lambda0.003.csv");  #took like 3 hours and did not converge
